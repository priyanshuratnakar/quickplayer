      ...
      <Flex flexDir={"column"} align={"center"} paddingBottom={"38px"}>
        ...
        >
          <Text paddingTop={"10px"}>
            <a href="#story" onClick={(event) => scrollTo(event, "#story")}>
              {" "}
              Story{" "}
            </a>
          </Text>
          ...
          <Button
            ...
            _hover={{ backgroundColor: "white", color: "#FF3465" }}
          >
            <a href="https://twitter.com/intent/user?user_id=1037821162548428800">
              Follow Creator{" "}
            </a>{" "}
          </Button>
        </Flex>
        ...
        <Flex flexDir={"column"} marginTop={{ base: "35vh ", md: "52px" }}>
          <Text
            fontSize={{ base: "40px", md: "128px" }}
            textAlign={"center"}
            letterSpacing={{ base: "3px", md: "7px" }}
            fontFamily={"Six Caps, sans-serif"}
            color={"white"}
          >
            WATCH YOUR FAVOURITE CONTENTS{" "}
          </Text>
        ...
        >
          <Link href="./player">
            <Image
              width={{ base: "200px", md: "368px" }}
              height={{ base: "200px", md: "375px" }}
              src="./cta2.png"
              alt="cta"
            />
          </Link>
        ...
        <Flex
          marginTop={{ base: "250px", md: "140px" }}
          gap={"58px"}
          width={{ base: "305px", md: "1400px" }}
          ...
          <Flex flexDir={"column"} gap={"38px"}>
            ...
            <Link href="./tmkoc">
              <Image
                ...
                src="./2.png"
                alt="tarak-mehta-ka-ooltah-chashmah"
              />
            </Link>
          </Flex>
          <Flex flexDir={"column"} gap={"38px"}>
        ...
        <div id="story">
          ...
          >
            ...
            <Text
              ...
              fontFamily={"poppins"}
            >
              The story starts when I was having my lunch and I&apos;ve this old
              habit of mine to watch something while eating. I&apos;m doing this
              since I was a kid and I belive we all do this. The problem arrives
              when we open OTT Platforms and start searching but coundn&apos;t find
              anything. I realized how good it was back then we just have to
        ...
        <Flex
          flexDir={"row"}
          color={"white"}
          marginTop={{ base: "150px", md: "180px" }}
          width={{ base: "293px", md: "1400px" }}
        ...
        >
          ...
          <Flex gap={{ base: "10px", md: "15px" }}>
            ...
            <a href="https://www.buymeacoffee.com/0xratnakar">
              <Image
                width={{ base: "99px", md: "165px" }}
                height={{ base: "21px", md: "34px" }}
